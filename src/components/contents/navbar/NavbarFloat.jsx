...
const NavbarFloat = () => {
  ...
  return (
    <div className="comps-container">
      <p className="comps-title">{menuComponents[1].title}</p>
      <h1 className="comps-h1">Navbar Float</h1>
      <p className="comps-desc">Responsive floating navbar</p>
      <div className="">
        <p className="text-xl font-semibold py-5 dark:text-white">Preview</p>
        <div className="flex mb-2">
          <div
            onClick={handleDevice}
            className={`flex items-center h-10 w-32 justify-center rounded-lg gap-x-1 cursor-pointer ${
              device ? "bg-zinc-200 dark:bg-zinc-800 dark:text-white" : "text-slate-500 dark:text-slate-400"
            }`}
          >
            <img
            ...
            />
            <img
              src={device ? laptopWhite : laptopUnclick}
              alt="laptop"
          ...
          >
            ...
            />
            <img
              src={device ? phoneUnclick : phoneWhite}
              alt="device"
              className="w-5 dark:block hidden"
            />
        ...
        <div className="overflow-auto w-full border-2 dark:border-slate-900 rounded-lg max-h-[350px] min-h-[350px] bg-[repeating-linear-gradient(0deg,transparent,transparent_0.4em,rgba(0,0,0,0.03)_0.5em),repeating-linear-gradient(90deg,transparent,transparent_0.4em,rgba(0,0,0,0.03)_0.5em)] dark:bg-[repeating-linear-gradient(0deg,transparent,transparent_0.4em,rgba(250,250,250,0.03)_0.5em),repeating-linear-gradient(90deg,transparent,transparent_0.4em,rgba(250,250,250,0.03)_0.5em)]">
          {device ? (
      ...
      <div className="">
        ...
        <div className="w-full border-2 max-h-96 rounded-lg bg-[#0D1117] dark:border-slate-700">
